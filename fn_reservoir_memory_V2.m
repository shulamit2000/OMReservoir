function [y_res]=fn_reservoir_memory_V2(mg_t, modmax,dt,dt1, y0, Pin,lambdaL, kappa_fb, kappa_inj, Id, num_nodes, max_pred_steps, init_length,train_length,test_length,DTcoeff)
    y=y0;
